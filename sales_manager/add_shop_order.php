...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO SuperShop_Orders (customer_id, total_amount, status, order_date) VALUES ($customer_id, $total_amount, '$status', '$order_date')";
...
<html lang="en">
  <head>
    ...
    <title>Add Shop Order - Sales Manager</title>
    <link rel="stylesheet" href="../style.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
  </head>
  <body>
    <?php include '../components/topbar.html'; ?>
    <?php $page_title = 'Add Shop Order'; include '../components/header.html'; ?>
    ...
    <main>
      <div class="card" style="max-width: 600px; margin: 0 auto">
        <div class="card-header">
          <span class="card-title">Add New Shop Order</span>
        </div>
        <?php if ($message): ?>
        ...
        <form action="" method="POST">
          ...
          <button type="submit" name="submit" class="btn-submit">
            <i class="fa fa-check"></i> Add Shop Order
          </button>
        </form>
      </div>
    </main>
