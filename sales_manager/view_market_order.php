...
if (isset($_GET['delete_order_id']) && $order_id) {
    ...
    if ($conn->query("DELETE FROM Orders WHERE order_id=$delete_id") === TRUE) {
...
<html lang="en">
  <head>
    ...
    <title>View Market Order - Sales Manager</title>
    <link rel="stylesheet" href="../style.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
  </head>
  <body>
    <?php include '../components/topbar.html'; ?>
    <?php $page_title = 'View Market Order'; include '../components/header.html'; ?>
    ...
    <main>
      ...
      <div class="card" style="max-width: 700px; margin: 0 auto">
        <div class="card-header">
          <span class="card-title">Market Order Details - ORD-<?php echo $order['order_id']; ?></span>
        </div>
        <div class="detail-section">
          <div class="detail-row">
            <span class="detail-label">Order ID:</span>
            <span class="detail-value">ORD-<?php echo $order['order_id']; ?></span>
          </div>
          <div class="detail-row">
        ...
        <div style="display: flex; gap: 10px; margin-top: 20px; flex-wrap: wrap;">
          <a href="update_market_order.php?order_id=<?php echo $order['order_id']; ?>" class="btn btn-warning">
            <i class="fa fa-edit"></i> Edit
          </a>
          <a href="view_market_order.php?order_id=<?php echo $order['order_id']; ?>&delete_order_id=<?php echo $order['order_id']; ?>" class="btn btn-danger" onclick="return confirm('Delete this order?');">
            <i class="fa fa-trash"></i> Delete
          </a>
          <a href="market_orders.php" class="btn btn-secondary">
